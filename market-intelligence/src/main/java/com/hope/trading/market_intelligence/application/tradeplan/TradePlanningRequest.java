...
public record TradePlanningRequest(
        Set<OpportunityId> opportunityIds, UUID tradingContextId, long contextVersion,
        UUID actorId, BigDecimal marketPrice, PlanningPreferences preferences,
    ...
    public TradePlanningRequest {
        ...
        Objects.requireNonNull(tradingContextId); Objects.requireNonNull(actorId);
        ...
        preferences = preferences == null ? PlanningPreferences.conservative() : preferences;
